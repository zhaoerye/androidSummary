...
public class AutoWrapLayout extends ViewGroup {
	...
	public AutoWrapLayout(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		horizontalSpace = ta.getDimension(R.styleable.AutoWrapLayout_horizontalSpace, 2);
		vertivalSpace = ta.getDimension(R.styleable.AutoWrapLayout_vertivalSpace, 2);
		ta.recycle();
